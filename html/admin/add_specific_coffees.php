...
?><h3>Add Goodies (Shirts/Gifts)</h3>

<form action="add_specific_coffees.php" method="post" accept-charset="utf-8">

	<fieldset><legend>Fill out the form to add goodies to the site.</legend>
		
		<div class="field"><label for="category"><strong>Type of Goodies:</strong></label><br />
		...
		<table border="0" width="100%" cellspacing="5" cellpadding="5">
			<thead>
			    ...
			    <th align="right">Printed/Plain</th>
			    <th align="right">White/Black</th>
		...
		$grinds = '<option value="printed">Printed</option><option value="plain">Plain</option>';
		
		// Need the caffeinated/decaffeinated options:
		$caf_decaf = '<option value="white">White</option><option value="black">Black</option>';
